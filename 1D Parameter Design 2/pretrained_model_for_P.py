...
def training_model(num, iterations):  # num是指加载多少组数据，iterations是指训练多少代
    # 加载训练集、验证集和测试集
    tr_bg, va_bg, te_bg, tr_param, va_param, te_param, bg_max, bg_min, param_max, param_min = load_data('dataset/dataset_for_1D_ternary.xlsx', 'P', 'parameters', num)
...
tr_bg, va_bg, te_bg, tr_param, va_param, te_param, bg_max, bg_min, param_max, param_min = load_data('dataset/dataset_for_1D_ternary.xlsx', 'P', 'parameters', 80000)
