...
def training_model():
    tr_lvs, va_lvs, te_vs, tr_sps, va_sps, te_sps, tr_bgs, va_bgs, te_bgs, lvs_max, lvs_min, sps_max, sps_min, bgs_max, bgs_min = load_data('dataset/bandgap_dataset.xlsx')
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1000):
            ...
            if (epoch+1)%100 ==0:
                saver.save(sess, 'pretrained_models/pretrained_forward_modeling_network_for_out_of_plane_waves.ckpt')
